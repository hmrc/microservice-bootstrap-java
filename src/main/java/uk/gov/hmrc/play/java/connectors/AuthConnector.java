...
public interface AuthConnector extends uk.gov.hmrc.play.auth.microservice.connectors.AuthConnector, Connector, uk.gov.hmrc.play.frontend.auth.connectors.AuthConnector {
    ...
    @Override
    default Future<Result> authorise(ResourceToAuthorise resource, AuthRequestParameters authRequestParameters, HeaderCarrier hc) {
        return AuthConnector$class.authorise(this, resource, authRequestParameters, hc);
    }
